...
CONF_GRENTON_TYPE_DIN = 'DIN'
CONF_GRENTON_TYPE_SATEL_INPUT = 'SATEL_INPUT'
CONF_GRENTON_TYPE_SATEL_OUTPUT = 'SATEL_OUTPUT'
CONF_GRENTON_TYPE_SATEL_ZONE = 'SATEL_ZONE'
